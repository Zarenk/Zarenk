...
- **Full-stack TS:** NestJS · Next.js (App Router) · Prisma · PostgreSQL/TimescaleDB · Redis · BullMQ · Socket.IO · React Query · Tailwind/shadcn
- **Python:** FastAPI · Playwright/web scraping · computer vision · robotics (PX4/MAVLink) · Celery
- **C# / .NET Framework:** WinForms · SQL Server · layered architecture · ReportViewer — production systems since 2019
- **Applied AI:** Anthropic Claude API (streaming, tool-use / agentic) · RAG · vector embeddings · multi-provider chatbots
- **DevOps:** Docker / Compose · monorepos (pnpm, Turborepo) · GitHub Actions CI · Railway / Vercel
...
|---|---|---|
| **ZentryxApp** — [zentryxapp.com](https://zentryxapp.com) | Production multi-tenant ERP for Peru: double-entry accounting, SUNAT e-invoicing, 8 business verticals, agentic legal assistant, 65+ modules. | NestJS · Prisma · PostgreSQL · Next.js · Socket.IO |
| **TechScraper** | Tech price-comparison platform (12 stores, ~8k+ listings): scrape → normalize → match pipeline, NLP product matching, daily cron, CI. | NestJS · BullMQ · TimescaleDB · Playwright/VTEX API · Next.js |
| **[TokenVision](https://github.com/Zarenk/tokenvision)** | Per-project token-usage tracker for Claude Code: live monitor, weekly budget, context-drain diagnostics. Desktop (Electron) + CLI + Chrome extension. | Node · Electron · CLI |
